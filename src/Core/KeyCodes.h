...
enum : KeyCode {
  ...
  // For US keyboards mapped to key 29 (Microsoft Keyboard Scan Code
  // Specification) For Non-US keyboards mapped to key 42 (Microsoft Keyboard
  // Scan Code Specification) Typical language mappings: Belg:£µ` FrCa:<>}
  // Dan:*' Dutch:`´ Fren:µ* Ger:'# Ital:§ù LatAm:[}` Nor:*@ Span:ç} Swed:*'
  // Swiss:$£} UK:~# Brazil:}]
  ...
  // For Non-US keyboards mapped to key 45 (Microsoft Keyboard Scan Code
  // Specification) Typical language mappings: Belg:<\> FrCa:«°» Dan:<\>
  // Dutch:]|[ Fren:<> Ger:<|> Ital:<> LatAm:<> Nor:<> Span:<> Swed:<|>
  // Swiss:<\> UK:\| Brazil: \|.
